  ...
  let boxes = [
    {
      ...
      imageAlt:
        "Abdul Basit Pawar, a Math tutor, portrait number 1",
      description:
    ...
    },
    {
      ...
      imageAlt:
        "Abdul Basit Pawar, a Math tutor, portrait number 2",
      description:
    ...
    },
    {
      ...
      imageAlt:
        "Abdul Basit Pawar, a Math tutor, portrait number 3",
      description:
...
<section id="about" class="about mb-16 mt-4">
  ...
  <!-- <div class="about-container flex flex-col {sectionHorizontalPadding} mt-10">
    <div class="flex gap-8">
      ...
      >
        <img src="/abdul-basit-portrait-1.jpg" alt="Abdul Basit Pawar, a Math tutor, portrait number 1" />
      </div>
      <div
        class="border border-[#ddd] rounded-t-lg shadow-md flex-1 overflow-hidden"
      >
        <img src="/abdul-basit-portrait-2.jpg" alt="Abdul Basit Pawar, a Math tutor, portrait number 2" />
      </div>
      <div
        class="border border-[#ddd] rounded-t-lg shadow-md flex-1 overflow-hidden"
      >
        <img src="/abdul-basit-portrait-3.jpg" alt="Abdul Basit Pawar, a Math tutor, portrait number 3" />
      </div>
    </div>
    <div class="flex gap-8">
      {#each boxes as box}
